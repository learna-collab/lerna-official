...
export default function SchoolAdminLessonDetailPage() {
  ...
  // Timer is informational only. Reset each section via a queued
  // post-commit update instead of synchronously writing state during
  // the effect body.
  useEffect(() => {
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6 p-6">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        {isLast ? (
          <Button asChild>
            <Link href="/school-admin/lessons">Finish Lesson</Link>
          </Button>
        ) : (
